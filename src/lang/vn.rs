...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Your ID", "ID của bạn"),
        ("Password Private", "Mật khẩu riêng"),
        ("Running Windows", "Khởi động cùng máy tính"),
        ("Confirmation", "Nhập lại mật khẩu vn"),
        ("Slogan BViewer", " Phần mềm điều khiển máy tính từ xa"),
        ("About BViewer", "GIỚI THIỆU BVIEWER - "),
        ("Email", "Email liên hệ: bkavpro@bkav.com"),
        ("Version", "Phiên bản:"),
        ("Connect OK", "Sẵn sàng kết nối"),
        ("Introduct", "Trang chủ:"),
        ...
        ("connecting_status", "Đang kết nối đến Bkav..."),
        ...
        ("not_ready_status", "Kết nối chưa sẵn sàng"),
        ...
        ("selinux_tip", ""),
        ("receive_file", "Nhận tệp tin"),
        ("send_file", "Gửi tệp tin"),
        ("delete_file", "Xóa tệp tin"),
