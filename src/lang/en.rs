...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Running Windows", "Start with the computer"),
        ("Slogan BViewer", " - Remote computer control software"),
        ("Confirmation", "Enter the password again"),
        ("About BViewer", "ABOUT BVIEWER"),
        ("Email", "Email liên hệ: bkavpro@bkav.com"),
        ("Version", "Version:"),
        ("Introduct", "Introduct:"),
        ("Source code", "Source code:"),
        ("connecting_status", "Connecting to the Bkav network..."),
        ("Enable Service", "Enable service"),
        ("Start Service", "Enable service"),
        ("Connect OK", "Ready to connect"),
        ("not_ready_status", "Connection is not ready"),
        ("Transfer File", "Transfer file"),
        ("Recent Sessions", "Recent sessions"),
        ("Address Book", "Address book"),
        ("TCP Tunneling", "TCP tunneling"),
        ("Enable Keyboard/Mouse", "Enable keyboard/mouse"),
        ("Allow using keyboard and mouse", "Allows use of mouse and keyboard"),
        ("Allow using clipboard", "Allows use of clipboard"),
        ("Allow hearing sound", "Allows listening to sound"),
        ("Allow file copy and paste", "Allows copying and pasting"),
        ("Enable Clipboard", "Enable clipboard"),
        ("Allow remote restart", "Allows restarting the computer remotely"),
        ("Allow recording session", "Allow video recording"),
        ...
        ("Slogan_tip", "GNU AFFERO GENERAL PUBLIC LICENSE BViewer là phần mềm miễn phí được phát triển dựa trên phần mềm mã nguồn mở RustDesk; bạn có thể sửa đổi, phân phối phần mềm theo các điều khoản của giấy phép GNU Affero General Public License phiên bản 3.0 do Free Software Foundation xuất bản.Chương trình này được phân phối với mong muốn nó sẽ hữu ích nhưng KHÔNG CÓ BẤT KỲ SỰ ĐẢM BẢO NÀO; thậm chí không có đảm bảo ngầm định nào về TÍNH THƯƠNG MẠI CỦA SẢN PHẨM hoặc SỰ PHÙ HỢP VỀ CÔNG DỤNG CỦA SẢN PHẨM CHO MỘT MỤC ĐÍCH CỤ THỂ.Bạn có thể xem về giấy phép GNU Affero General Public License để biết thêm chi tiết "),
