...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("BViewer".to_owned()));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["bviewer.bkav.com"];
pub const RS_PUB_KEY: &str = match option_env!("RS_PUB_KEY") {
    Some(key) if !key.is_empty() => key,
    _ => "DnzDxW6otYIkb7Mmt1s665IsI/hskqO92A7mdgKyLro=",
};
